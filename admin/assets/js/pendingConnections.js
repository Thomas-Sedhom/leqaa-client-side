...
function createConnectionRow(connectedUser, otherUser){
	...
	userProfileLink.href = `file:///D:/work/seeko/seeko-front/admin/pendingUser.html?id=${connectedUser._id}`;
	...
	otherUserProfileLink.href = `file:///D:/work/seeko/seeko-front/admin/pendingUser.html?id=${otherUser._id}`;
