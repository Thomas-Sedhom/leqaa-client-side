...
//-------------------------------------------------------------------------------------------------------------------
// governrate and city select input
...
//----------------------------------------------------------------------------------------------------------
// permanentDiseasesDetails section
...
const completeRedData = async (formData) => {
	...
	const response = await fetch(`http://localhost:3000/api/v1/auth/updateUser/${id}`, {
		method: 'POST',
		body: formData,
		credentials: 'include',
	})
...
// fetch user data
const userApi = async () => {
	const response = await fetch(`http://localhost:3000/api/v1/user/profile/${id}`, {
		method: 'GET',
		headers: {
