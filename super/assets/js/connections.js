	...
	try {
		...
		connections.forEach((connection) => {
			...
			if(commission == null || commission == undefined || !commission)
				createConnectionRow(connectedUser, otherUser, date, connectionId);
		});
	} catch (error) {
...
function createConnectionRow(connectedUser, otherUser, date, connectionId){
	...
	confirmButton.addEventListener("click", () => 
        window.location.href = `commission.html?id=${connectionId}`
    );
