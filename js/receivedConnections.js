...
async function createUserCards() {
   ...
   for (const user of users) {
      ...
      image.src = user.sender.faceImage || "./images/default-user.png"; // Set default image if missing
      image.alt = `${user.sender.firstName}'s profile picture`; // Add alt text for accessibility
      ...
      link.href = `file:///D:/work/seeko/seeko-front/userRequest.html?id=${user.sender._id}`
